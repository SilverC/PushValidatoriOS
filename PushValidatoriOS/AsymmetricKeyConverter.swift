//
//  AsymmetricKeyConverter.swift
//  PushValidatoriOS
//
//  Created by Casey Silver on 11/17/19.
//  Copyright © 2019 Casey Silver. All rights reserved.
//
// Taken from https://github.com/DigitalLeaves/CryptoExportImportManager/blob/master/CryptoLoadExternalCertificate/CryptoExportImportManager.swift
...
private let ASNHeaderIntegerMark: UInt8 = 02 // 0x32
private let ASNHeaderBitstringMark: UInt8 = 03 //0x03
private let ASNHeaderNullMark: UInt8 = 05 //0x05
private let ASNHeaderRSAEncryptionObjectMark: UInt8 = 06 //0x06
...
private let PublicNumberOfCharactersInALine = 64

class AsymmetricKeyConverter: NSObject {
    /**
    ...
    func PEMKeyFromDERKey(_ data: Data) -> String {
        ...
        for character in base64EncodedString {
            ...
            if charCount == PublicNumberOfCharactersInALine {
